...
export const featureGroups: Partial< FeatureGroupMap > = {
	...
	// WordPress Hosting Intent Feature Groups
	[ FEATURE_GROUP_WP_HOSTING_ESSENTIALS ]: {
		slug: FEATURE_GROUP_WP_HOSTING_ESSENTIALS,
		getTitle: () => null, // No title for this group
		getFeatures: () => [ FEATURE_UNLIMITED_TRAFFIC, FEATURE_CUSTOM_DOMAIN ],
	},
	[ FEATURE_GROUP_WP_HOSTING_MANAGED ]: {
		slug: FEATURE_GROUP_WP_HOSTING_MANAGED,
	...
	[ FEATURE_GROUP_WP_HOSTING_DEVELOPER ]: {
		slug: FEATURE_GROUP_WP_HOSTING_DEVELOPER,
		getTitle: () => i18n.translate( 'Developer Tools' ),
		getFeatures: () => [
			FEATURE_SITE_STAGING_SITES,
			FEATURE_SEAMLESS_STAGING_PRODUCTION_SYNCING,
	...
	[ FEATURE_GROUP_WP_HOSTING_SUPPORT ]: {
		slug: FEATURE_GROUP_WP_HOSTING_SUPPORT,
...
export function resolveFeatureGroupsForComparisonGrid( props?: {
	...
	const marketingGrowthGroup = isExperimentVariant
		? ( {
				slug: FEATURE_GROUP_MARKETING_GROWTH_AND_MONETIZATION_TOOLS,
				getTitle: () => i18n.translate( 'Growth and monetization tools' ),
				getFeatures: () => [
	...
	const themesAndCustomizationGroup = isExperimentVariant
		? ( {
				slug: FEATURE_GROUP_THEMES_AND_CUSTOMIZATION,
				getTitle: () => i18n.translate( 'Design customization' ),
				getFeatures: () => [
	...
	return {
		...
		[ FEATURE_GROUP_THEMES_AND_CUSTOMIZATION ]: themesAndCustomizationGroup,
		[ FEATURE_GROUP_SUPERIOR_COMMERCE_SOLUTIONS ]:
			featureGroups[ FEATURE_GROUP_SUPERIOR_COMMERCE_SOLUTIONS ],
		[ FEATURE_GROUP_MARKETING_GROWTH_AND_MONETIZATION_TOOLS ]: marketingGrowthGroup,
		[ FEATURE_GROUP_STORAGE ]: featureGroups[ FEATURE_GROUP_STORAGE ],
	};
}
...
export function resolveWordPressHostingFeatureGroupsForFeaturesGrid(): Partial< FeatureGroupMap > {
	return {
		[ FEATURE_GROUP_STORAGE ]: featureGroups[ FEATURE_GROUP_STORAGE ],
		[ FEATURE_GROUP_WP_HOSTING_ESSENTIALS ]: featureGroups[ FEATURE_GROUP_WP_HOSTING_ESSENTIALS ],
		[ FEATURE_GROUP_WP_HOSTING_MANAGED ]: featureGroups[ FEATURE_GROUP_WP_HOSTING_MANAGED ],
		[ FEATURE_GROUP_WP_HOSTING_DEVELOPER ]: featureGroups[ FEATURE_GROUP_WP_HOSTING_DEVELOPER ],
		[ FEATURE_GROUP_WP_HOSTING_SUPPORT ]: featureGroups[ FEATURE_GROUP_WP_HOSTING_SUPPORT ],
		[ FEATURE_GROUP_WP_HOSTING_COMMERCE ]: featureGroups[ FEATURE_GROUP_WP_HOSTING_COMMERCE ],
	};
}
